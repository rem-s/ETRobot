...
#define CYC2_PRIORITY 	TMIN_APP_TPRI + 5 /* 周期タスク2の優先度(周期タスク1より優先度小さいとスタートがうまくいかない) */
#define CYC3_PRIORITY 	TMIN_APP_TPRI + 2 /* 周期タスク3の優先度 */
#define CYC4_PRIORITY 	TMIN_APP_TPRI + 4 /* 周期タスク4の優先度 */
#define CYC5_PRIORITY 	TMIN_APP_TPRI + 4 /* 周期タスク5の優先度(周期タスク1と同じ) */
#define CYC6_PRIORITY 	TMIN_APP_TPRI + 4 /* 周期タスク6の優先度 */
#define CYC7_PRIORITY 	TMIN_APP_TPRI + 4 /* 周期タスク7の優先度 */
...
#define START_TAIL_POSITION 96  // 95以下だと後ろに倒れる可能性が大きくなる
// #define ISRUN_TAIL_POSITION 5
#define ISRUN_TAIL_POSITION 20

#define LOOKUP_TAIL_POSITION 63
#define WAKEUP_TAIL_POSITION 80
...
extern void cyc_task6(intptr_t exinf);
extern void cyc_handler6(intptr_t exinf);
extern void cyc_task7(intptr_t exinf);
extern void cyc_handler7(intptr_t exinf);
